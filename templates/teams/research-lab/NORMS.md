...
| 阶段 | 质量要求 |
|------|---------|
| 框架 → 调研 | 研究问题精确、成功标准明确、假设可检验 |
| 调研 → 验证 | 每个发现有证据支持、置信度已标注、负证据已记录 |
| 验证 → 综合 | 所有交叉审查完成、分歧已解决或升级、质疑已回应 |
| 综合 → 交付 | 执行摘要完整、方法论透明、建议可操作 |

## 错误恢复

- **研究方向错误**：及时止损，记录为"死胡同"发现（`memory_save` with tags: `["insight", "dead-end"]`），转向下一个假设。
- **来源冲突**：两个权威来源给出矛盾信息时，深入查证第三方来源，在报告中如实反映不确定性。
- **时间压力**：如果调研时间不足以完成所有角度，优先完成最高影响的调研线索，明确标注哪些角度未覆盖。
