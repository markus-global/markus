...
export const PROVIDERS: ProviderModel[] = [
  {
    ...
    isAnthropic: true,
    models: ['claude-opus-5', 'claude-opus-4-6', 'claude-sonnet-4-6', 'claude-sonnet-4-5', 'claude-haiku-3-6'],
  },
  {
    id: 'openai',
    label: 'OpenAI',
  ...
  },
  {
    ...
    models: ['gemini-3-1-pro', 'gemini-3-1-flash', 'gemini-3-6-flash', 'gemini-3-0-flash', 'gemini-2-5-pro'],
  },
  {
    id: 'minimax',
