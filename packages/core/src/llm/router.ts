...
const BUILTIN_MODEL_CATALOG: ModelDefinition[] = [
  ...
  { id: 'markus-lite', name: 'Markus Lite', provider: 'markus', contextWindow: 1000000, maxOutputTokens: 384000, cost: { input: 0.14, output: 0.28, cacheRead: 0.0028 }, reasoning: false, inputTypes: ['text'], tier: 'base', description: 'Fast and affordable text model via Markus platform' },
  { id: 'markus-pro', name: 'Markus Pro', provider: 'markus', contextWindow: 1000000, maxOutputTokens: 384000, cost: { input: 1.74, output: 3.48, cacheRead: 0.0145 }, reasoning: false, inputTypes: ['text'], tier: 'pro', description: 'High-quality text model via Markus platform' },
];
