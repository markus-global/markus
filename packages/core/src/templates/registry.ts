  ...
  const builtins: AgentTemplate[] = [
    {
      ...
      roleId: 'developer',
      agentRole: 'worker',
      skills: ['git', 'typescript', 'javascript', 'node', 'react'],
    ...
    },
    {
      ...
      roleId: 'reviewer',
      agentRole: 'worker',
      skills: ['code-review', 'static-analysis', 'typescript'],
    ...
    },
    {
      ...
      agentRole: 'manager',
      skills: ['project-planning', 'task-tracking', 'agile'],
    ...
    },
    {
      ...
      roleId: 'qa-engineer',
      agentRole: 'worker',
      skills: ['test-automation', 'integration-testing', 'typescript'],
    ...
    },
    {
      ...
      roleId: 'devops',
      agentRole: 'worker',
      skills: ['ci-cd', 'docker', 'kubernetes', 'cloud-deployment'],
    ...
    },
    {
      ...
      agentRole: 'worker',
      skills: ['data-analysis', 'research', 'summarization'],
    ...
    },
    {
      ...
      roleId: 'support',
      agentRole: 'worker',
      skills: ['ticketing', 'customer-communication', 'troubleshooting'],
    ...
    },
    {
      ...
      roleId: 'operations',
      agentRole: 'manager',
      skills: ['process-optimization', 'resource-planning', 'coordination'],
    ...
    },
    {
      ...
      agentRole: 'manager',
      skills: ['product-strategy', 'roadmap-planning', 'user-research', 'stakeholder-communication'],
