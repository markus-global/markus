...
export class Agent {
  ...
  private async _executeTaskInternal(
    ...
    const taskPrompt = [
      ...
      'Each deliverable should have an absolute `path` and a brief `summary` describing the file.',
      'Example: deliverables: [{ "path": "/absolute/path/to/output.md", "summary": "Generated marketing copy" }]',
      'This makes your outputs easily accessible to reviewers and other team members.',
      '',
